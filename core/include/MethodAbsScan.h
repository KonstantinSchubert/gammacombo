...
class MethodAbsScan
{
    public:
        ...
        const vector<RooSlimFitResult*>& getAllResults(){return allResults;};
        const vector<RooSlimFitResult*>& getCurveResults(){return curveResults;};
        float                    getChi2minGlobal(){return chi2minGlobal;}
        ...
        int                      getNObservables(){return w->set(obsName)->getSize();}
        int                      getNPoints1d(){return nPoints1d;}
        int                      getNPoints2dx(){return nPoints2dx;}
        int                      getNPoints2dy(){return nPoints2dy;}
        const RooArgSet*         getObservables(){return w->set(obsName);}
        TString                 getObsName(){return obsName;};
        TString                 getParsName(){return parsName;};
        ...
        virtual int                     scan1d();
        virtual int                     scan2d();
        void                            setDrawSolution(int code=0){drawSolution = code;};
        void                            setPValueCorrector(PValueCorrection *pvalCor) { pvalueCorrector = pvalCor; pvalueCorrectorSet=true; }
        void                            setScanVar1(TString var){scanVar1 = var;};
        void                            setScanVar2(TString var){scanVar2 = var;};
        void                            setNPoints1d(int n){nPoints1d = n;};
        void                            setNPoints2dx(int n){nPoints2dx = n;};
        void                            setNPoints2dy(int n){nPoints2dy = n;};
        void                            setFilled(bool filled){ drawFilled = filled;};
        void                            setLineColor(int c){lineColor = c;};
        void                            setLineStyle(int c){lineStyle = c;};
        void                            setTextColor(int c){textColor = c;};
        void                            setTitle(TString s){title = s;};
